...
function Animate_ggas() {
    //document.getElementsByClassName("preview_box_ggas").style.display = "block";
    jQuery('.preview_box_ggas').css('display', 'block');
...
function StopAnimate_ggas() {
    //document.getElementsByClassName("preview_box_ggas").style.display = "none";
    jQuery('.preview_box_ggas').css('display', 'none');
...
function InitPreview_ggas() {
    ...
    jQuery('.preview_box_ggas').css('visibility','hidden');
...
function OnLoadAllPics_ggas() {
    ...
    var strHeight = nHeight_ggas.toString();
    strHeight += "px";
    jQuery('preview_box_ggas').css('height', 'strHeight');

    jQuery('preview_box_ggas').css('visibility', 'visible');
